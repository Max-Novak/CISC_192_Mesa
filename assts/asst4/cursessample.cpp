...
Student:
This is a good example of a curses application, and unlike spoon-feeding as
education, there is a reason you might want to study the code: it's cool.
As far as I know, no C class in town teaches beginning programmers ANYTHING
about the Ncurses Library.  That's a mistake.  When and my peers were learning
programming, we did it almost exclusively building simple kaleidescope programs
in Applesoft BASIC. If it were left up to me, I'd start teaching kids programming
with "Python for Kids" using the TKinter add-ons.
-----------------------------------------------------------------*/
#include <cstdio>
#include <cstdlib>
#include <ctype.h>
