...
//char DEAD = '.' ; 
char DEAD = ' ' ; 
unsigned int count, status[2] = {0} , timer = 0  ; 

int randomize_screen()
{
	int i, j ;
	for (i = 0 ; i < ROWS ; i++)
		for (j = 0 ; j < COLS ; j++)
...
--------------------------------------------------*/ 
die(int a ) 	/*terminate & write a checkpoint file */ 
{ 
	int i , j, c ; 
	FILE *ifp ; 
